...
//  PhotoLib
//
//  Created by indianic on 29/12/20.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func doPick (_ sender: Any) {
        ...
        do {
            ...
            config.filter = .any(of:[.images ,.videos]) // default is all three appear, no filter
...
//        iv.startAnimating()
    ...
    func showMovie(url:URL) {
        ...
        let documentsDirectory =  FileManager.default.temporaryDirectory
                ...
                // get the documents directory url
                let docDir2 = FileManager.default.temporaryDirectory.appendingPathComponent("Videos")
                // choose a name for your image
                let fileName = "PBHealth.mp4"

                // create the destination file url to save your image

                
                
        let myDocPath = documentsDirectory.appendingPathComponent("PBHealth/Photos").appendingPathComponent("temp.mp4").absoluteString
        ...
        exportSession!.exportAsynchronously { () -> Void in
            ...
            case .failed:
                ...
                //     self.objVC?.displayActivityIndicator(shouldDisplay: false)
